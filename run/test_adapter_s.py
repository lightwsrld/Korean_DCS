...
g.add_argument("--lora_dir", type=str, required=True, help="LoRA weight")
...
def main(args):
    ...
    model = PeftModel.from_pretrained(base_model, args.lora_dir)  # new_model 위치에 LoRA 가중치 경로(args.lora_dir)를 넣음
