...
g.add_argument("--model_id", type=str, required=True, help="huggingface model id or path")
...
g.add_argument("--adapter_path", type=str, required=True, help="path to the trained adapter")
# fmt: on
